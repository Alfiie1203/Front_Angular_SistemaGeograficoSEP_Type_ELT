...
@Component({
  selector: 'app-review-form-verify',
  templateUrl: './review-form-verify.component.html',
  styleUrls: ['./review-form-verify.component.scss']
})
export class ReviewFormVerifyComponent implements OnInit {
  ...
  idForm:any;
  idPrev:any;
  listValidate = [{id: 'NVE', name:'no_verified'}, { id: 'ARE', name:'self_reported'}, { id: 'VER', name:'verified'}]
  dataQuestion:any;
  ...
  register(){
    ...
    if(this.form.valid){
      ...
      this.apiService.getResponse('PATCH', `formulario/verificate/submit/formulario/${this.idForm}/`)
        .then((resp:any)=>{
  ...
  saveV(){
    ...
    this.assingData();
      // this.apiService.getResponse('PATCH', `formulario/submitformulario/${this.idForm}/`)
      this.apiService.getResponse('PATCH', `formulario/verificate/submitpartial/formulario/${this.idForm}/`)
        .then(resp=>{
  ...
  setValidate(validate:any){
    if( validate == 'NVE')
      return {id: 'NVE', name:'no_verified'};
    if( validate == 'ARE')
      return { id: 'ARE', name:'self_reported'};
    if( validate == 'VER')
      return { id: 'VER', name:'verified'};
    return null;
  }
